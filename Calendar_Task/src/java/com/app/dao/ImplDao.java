...
import com.app.controller.FacesUtil;
...
public class ImplDao<T,ID> implements IDao<T,ID>{
    ...
    public ImplDao() {
        this.emf = Persistence.createEntityManagerFactory("Calendar_TaskPU");
    }
    ...
    public void crear(T entity) {
        ...
        try {
            ...
            FacesUtil.addInfoMessage("Added in system!");
        } catch (PersistenceException pe) {
            FacesUtil.addErrorMessage("Persistence Error: " + pe.getMessage());
        } finally {
    ...
    public void eliminar(Object entity) {
        ...
        try {
            ...
            em.remove(entity);
            em.getTransaction().commit();
            FacesUtil.addInfoMessage("Deleted!");
        } catch (PersistenceException pe) {
            em.getTransaction().rollback();
            FacesUtil.addErrorMessage("Persistence Error: " + pe.getMessage());
        } finally {
